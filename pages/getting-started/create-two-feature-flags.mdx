...
![The "Onboarding" dialog.](../getting-started/assets/create-2-feature-flag/get-started.png)
...
<Callout type="info" emoji="ℹ️">
  This is a quick start, so that you can only create a boolean feature flag in this guide. If you want to create a feature flag with other data types, you can follow the guide in the [Create a feature flag](../feature-flags/create-a-feature-flag/) article.
</Callout>

![](../getting-started/assets/create-2-feature-flag/get-started-001.png)
...
FeatBit also provides other SDKs for different platforms (such as React, React Native, .NET client, and so on), you can find the SDKs in the [SDKs](../sdk/overview) page. In the detail page of each SDK, you will discover the more information and examples of how to use the SDK.
...
<Callout type="info" emoji="ℹ️">
  If the verification is failed, it may just a small bug of verification process. You can continue to read the next articles to see if you can control the feature behavior by changing the feature flag's status.
</Callout>
