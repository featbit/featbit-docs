...
4. Select the environments that this relay proxy can serve. You can choose one or more environments, or choose **All Environments** to allow the relay proxy to serve all environments within current organization.
...
After you create a relay proxy, a dialog will appear to show the ApiKey for this relay proxy. Make sure to copy and save it somewhere secure, as it will **not** be displayed again. Use this key to start your FeatBit Agent. You can close this dialog after copying the key.
...
<Callout type="info">
  Users with only `ListRelayProxies` permission can monitor relay proxy status but cannot make configuration changes.
</Callout>
