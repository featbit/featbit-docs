...
2. Alternatively, you have installed FeatBit via [Docker Installation](../installation/docker-compose.mdx).

## Initialize Environment

If this is your initial login, follow the steps below to specify your project and environments.

![Initialize Organization page](../getting-started/assets/create-2-feature-flag/002-init-org.webp)

Once completed, click the **Complete setup** button to proceed.

## Create a feature flag

Create a new feature flag named "**game runner**" and click **Create & continue**.

<Callout type="info">
  This guide demonstrates creating a boolean feature flag for simplicity. For different data types, refer to our [Create a multi-variant feature flag](./create-a-multi-variant-feature-flag.mdx) guide.
</Callout>

![](../getting-started/assets/create-2-feature-flag/003.png)

## Connect An SDK

The second step provides starter code to integrate FeatBit into your app and demonstrates basic usages of the SDK. 
The image below shows the JavaScript starter code. For a list of supported SDKs, please check out the [SDK Overview](../sdk/overview.md#supported-sdks) page.
...
The image below shows the testing step of the feature flag "game runner".
