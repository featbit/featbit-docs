...
For team communication, use Webhooks with chat integrations such as [Slack](/docs/v5/integrations/chat-apps/slack). This helps the team see when a flag is turned on, expanded, paused, or rolled back without manually checking the FeatBit dashboard.
