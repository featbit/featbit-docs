...
Read more: [Define flag types](./flag-lifecycle-management/define-flag-types.mdx)
...
Read more: [Set cleanup expectations](./flag-lifecycle-management/set-cleanup-expectations.mdx)
...
- Create flags through the FeatBit UI. This is the traditional path and is covered in [Create two feature flags](/v5/getting-started/create-two-feature-flags).
- Create flags through the OpenAPI. Use this when you need automation or integration with another system. Read more in the [API docs overview](/v5/api-docs/overview).
- Create flags with a coding agent by using FeatBit CLI or FeatBit MCP. Read more in [Create feature flags with coding agents](./flag-lifecycle-management/create-flags-with-agent-guidance.mdx).
...
Read more: [Implement feature flags](./flag-lifecycle-management/implement-feature-flags.mdx)
...
Read more: [Monitor release health](./flag-lifecycle-management/monitor-release-health.mdx)
...
Read more: [Control exposure, release decisions, and learning](./flag-lifecycle-management/control-exposure-and-release-decisions.mdx)
...
Read more: [Detect stale feature flags](./flag-lifecycle-management/detect-stale-feature-flags.mdx)
...
Read more: [Clean up feature flags with coding agents](./flag-lifecycle-management/clean-up-feature-flags-with-coding-agents.mdx)
...
- [Archiving and Deleting](./organizing-flags/archiving-and-deleting.mdx) explains the FeatBit product flow for archiving and deleting flags.
- [Audit log](./audit-log.mdx) explains how to inspect historical flag changes.
