...
**For more information about WebHook's payload template, please refer this [tutorial](/docs/v5/integrations/webhooks).**
...
You need to first create a Flag Trigger in a Feature Flags. See [Workflow/Flag Triggers](/docs/v5/feature-flags/feature-workflow/flag-triggers). For this tutorial's use case, you need to create a trigger to deactivate the feature flag.
