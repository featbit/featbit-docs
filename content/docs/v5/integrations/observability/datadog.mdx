...
**For more information about WebHook, please refer this [tutorial](/v5/integrations/webhooks).**
...
1. You need to first create a Flag Trigger in a Feature Flags. See [Workflow/Flag Triggers](/v5/feature-flags/feature-workflow/flag-triggers).
