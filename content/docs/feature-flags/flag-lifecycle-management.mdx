...
- Create flags through the FeatBit UI. This is the traditional path and is covered in [Create two feature flags](/docs/getting-started/create-two-feature-flags).
- Create flags through the OpenAPI. Use this when you need automation or integration with another system. Read more in the [API docs overview](/docs/api-docs/overview).
