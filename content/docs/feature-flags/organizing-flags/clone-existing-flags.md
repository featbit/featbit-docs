...
2. Click the three dots button and then the **Clone** action button to open the "Clone feature flag" dialog.
...
4. The **Key** field auto-populates based on the name you enter, but you can modify it if needed.
