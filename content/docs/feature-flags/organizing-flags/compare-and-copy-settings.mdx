---
title: Compare and copy settings
---
...
2. Click the three dots button and then **Compare** to open the Compare drawer, as shown below:

   ![Compare feature flag drawer](../assets/organizing-flags/compare-and-copy-settings/compare-drawer.png)

3. In the drawer, select the target environments to compare with the current environment.
