...
![](../../feature-flags/assets/targeting-users-with-flags/targeting-rules/001.png)

To create a rule that serves `true` to all users whose email address ends with `gmail.com`:

1. Click **Add rules** icon.

![](../../feature-flags/assets/targeting-users-with-flags/targeting-rules/002.png)
...
![](../../feature-flags/assets/targeting-users-with-flags/targeting-rules/003.png)

To learn more, read [Percentage rollouts](./percentage-rollouts.mdx).
...
| user is in segment, user is not in segment | segment names | User is included or excluded by the targeting rules for the named segments. To learn more, read [User segments](../users-and-user-segments/user-segments.md). |

## Setting the default rule when the flag is ON <a href="#setting-the-default-rule" id="setting-the-default-rule"></a>
...
![](../../feature-flags/assets/targeting-users-with-flags/targeting-rules/005.png)
...
## Setting the default rule when the flag is OFF <a href="#setting-the-default-off-variation" id="setting-the-default-off-variation"></a>
...
![](../../feature-flags/assets/targeting-users-with-flags/targeting-rules/006.png)
   1. First variation
   2. Second variation
   3. Third variation
   4. ...
2. Targeting user customized rules\
![](../../feature-flags/assets/targeting-users-with-flags/targeting-rules/007.png)
...
![](../../feature-flags/assets/targeting-users-with-flags/targeting-rules/008.png)
