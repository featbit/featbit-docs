...
You can change a flag's default values by changing **When flag is ON/OFF, serve** of the default rule.
...
![](../feature-flags/assets/create-flag-variations/003.png)
...
![](../feature-flags/assets/create-flag-variations/004.png)

You can also use multivariate flags to perform testing with FeatBit's Experimentation feature. To learn more, read [Control exposure, release decisions, and learning](./flag-lifecycle-management/control-exposure-and-release-decisions.mdx).
