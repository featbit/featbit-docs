...
> In this query you will get FeatBit's feature flag usage data (you can also call it Feature Flag Expriment Assignment data) from ClickHouse. For more information about the data, please follow [Data Export Doc](/docs/data-import-and-export/data-export).
...
> In this query you will get FeatBit's Experiment events data (you can also call it Metric data) from ClickHouse. For more information about the data, please follow [Data Export Doc](/docs/data-import-and-export/data-export).
